...
public class OrderResponseDTOTest {
	...
	public void testDefaultConstructor() {
	    ...
	    assertEquals("", orderResponseDTO.getUserCpf());
	...
	@Test
	public void testConstructorWithOrderIdAnduserName() {
	    Long orderId = 1L;
	    ...
	    OrderResponseDTO orderResponseDTO = new OrderResponseDTO(orderId, userName, orderTime, completedTime, totalPrice, orderStatus);
	...
	@Test
	public void testConstructorWithuserCpfAnduserName() {
		Long orderId = 0L;
	    ...
	    OrderResponseDTO orderResponseDTO = new OrderResponseDTO(orderId, userCpf, userName, orderTime, completedTime, totalPrice, orderStatus);

	    assertEquals(0L, orderResponseDTO.getOrderId());
	    assertEquals(userCpf, orderResponseDTO.getUserCpf());
	    assertEquals(userName, orderResponseDTO.getUserName());
	    assertEquals(orderTime, orderResponseDTO.getOrderTime());
	    assertEquals(completedTime, orderResponseDTO.getCompletedTime());
	    assertEquals(totalPrice, orderResponseDTO.getTotalPrice());
    ...
    public void testConstructorWithAllFields() {
        ...
        OrderResponseDTO orderResponseDTO = new OrderResponseDTO(orderId, orderNumber, userCpf, userName, orderTime, 
    ...
    public void testConstructorWithAllFieldsExceptOrderIdAndOrderNumber() {
        ...
        OrderResponseDTO orderResponseDTO = new OrderResponseDTO(userCpf, userName, orderTime, completedTime, totalPrice, orderStatus, orderItems);
    ...
    public void testAllGettersAndSetters() {
        ...
        assertEquals("12345678900", orderResponseDTO.getUserCpf());
        assertEquals("John Doe", orderResponseDTO.getUserName());
    }
}